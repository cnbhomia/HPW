...
*following variables are mass flow rates in Barrels
    ...
    LN2PRE  'LN sent for Premium Petrol blending'
    LN2REG  'LN sent for Regular Petrol blending '
    MN2REF  'MN sent to Reformer'
    MN2PRE  'MN used for Premium Petrol blending'
    MN2REG  'MN used for Regular Petrol blending'
    HN2REF  'HN sent to Reformer'
    HN2PRE  'HN used for Premium Petrol blending'
    HN2REG  'HN used for Regular Petrol blending'
    RG2REG  'Reformed Gas for Regular Petrol blending' 
    RG2PRE  'Reformed Gas for Premium Petrol blending' 
...
Equations
    ...
    LNbal   'Material Balance for Light Naptha'
    MNbal   'Material Balance for Medium Naptha'
    HNbal   'Material Balance for Heavy Naptha'
    LObal   'Material Balance for Light Oil'
    HObal   'Material Balance for Hevy Oil'
    RSbal   'Material Balance for Residumm'
    RGbal   'Material Balance for Reformed Gas'
    ...
    Premium 'Minimum Premium petrol production'
    PREOcNo 'Octane number limit for premium petrol'
    REGOcNo 'Octane number limit for regular petrol'
...
*Intermediatery streams mass balances
