...
table avail(mac,month) 'maintenance schedule. 0 = downtime'
       Jan  Feb Mar Apr May Jun
G1      0   1   1   1   0   1
G2      1   1   1   1   1   1
G3      1   1   1   1   1   1
...
processexists(process,month) $ [sum(mac$equipment(process,mac), avail(mac,month))] =1  ;
storecost = 0.5;
